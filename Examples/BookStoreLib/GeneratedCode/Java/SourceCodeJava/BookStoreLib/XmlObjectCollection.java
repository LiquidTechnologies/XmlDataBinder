...
/// </remarks>
public class XmlObjectCollection<T extends com.liquid_technologies.ltxmllib21.XmlObjectBase> extends com.liquid_technologies.ltxmllib21.XmlCollection<T> {
	private static final long serialVersionUID = 13L;

	public XmlObjectCollection(String elementName, String targetNamespace, int minOccurs, int maxOccurs, boolean isPseudoElement, Class<? extends com.liquid_technologies.ltxmllib21.XmlObjectBase> clazz) {
