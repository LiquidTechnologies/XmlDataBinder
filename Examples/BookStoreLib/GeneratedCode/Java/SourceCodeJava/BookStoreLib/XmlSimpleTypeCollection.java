...
/// </remarks>
public class XmlSimpleTypeCollection<T> extends com.liquid_technologies.ltxmllib21.XmlTypeCollection<T> {
	private static final long serialVersionUID = 13L;

	public XmlSimpleTypeCollection(String elementName, String targetNamespace, com.liquid_technologies.ltxmllib21.Conversions.ConversionType dataType, int minOccurs, int maxOccurs, String formatOverride, com.liquid_technologies.ltxmllib21.WhitespaceRule wsRule,
			com.liquid_technologies.ltxmllib21.PrimitiveRestrictions primValues) {
