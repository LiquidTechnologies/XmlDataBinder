Imports LiquidTechnologies.Viewer
...
Public Class SampleApp
    ...
    Private Sub SimpleTestBookstore(ByVal filename As String)
        Try
            ' create an instance of the class to load the XML file into
            Dim elm As BookStoreLib.Bookstore = New BookStoreLib.Bookstore()
            ...
            Dim sv As LiquidTechnologies.Viewer.SimpleViewer = New LiquidTechnologies.Viewer.SimpleViewer(elm)
            sv.ShowDialog()
            ...
            ' D:\Development21\Liquid\Applications\XmlDataBinder\Documentation\xml-data-binder\Evaluation\BookStoreDemo\GeneratedCode\VBNet\2022\DocumentationVBNet\.
    ...
    Private Sub SimpleTest(ByVal filename As String)
        Try
            ' create an instance of the class to load the XML file into
            Dim elm As LiquidTechnologies.Runtime.XmlObjectBase
            
            ' load the xml from a file into the object.
            elm = BookStoreLib.ClassFactory.FromXmlFile(filename)
