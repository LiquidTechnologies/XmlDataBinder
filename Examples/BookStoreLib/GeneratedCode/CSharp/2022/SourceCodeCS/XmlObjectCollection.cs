...
namespace BookStoreLib
{
    ...
    /// </remarks>
    public partial class XmlObjectCollection<T> : LiquidTechnologies.Runtime.XmlCollection<T> where T : LiquidTechnologies.Runtime.XmlObjectBase, new()
    {
...
// ##HAND_CODED_BLOCK_END ID="XmlObjectCollection Custom Base Methods"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
    ...
    /// hand coded blocks (or they will be lost when you re-generate the code.
    /// </remarks>
    public partial class XmlAbstractObjectCollection<T> : LiquidTechnologies.Runtime.XmlAbstractCollection<T> where T : LiquidTechnologies.Runtime.XmlObjectInterface
    {
...
// ##HAND_CODED_BLOCK_END ID="XmlEnumTypeCollection Custom Base Methods"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
    ...
    /// hand coded blocks (or they will be lost when you re-generate the code.
    /// </remarks>
    public partial class XmlSimpleTypeCollection<T> : LiquidTechnologies.Runtime.XmlTypeCollection<T>
    {
        public XmlSimpleTypeCollection(string elementName, string targetNamespace, LiquidTechnologies.Runtime.Conversions.ConversionType dataType, int minOccurs, int maxOccurs, string formatOverride, LiquidTechnologies.Runtime.WhitespaceUtils.WhitespaceRule wsRule, LiquidTechnologies.Runtime.PrimitiveRestrictions primValues)
