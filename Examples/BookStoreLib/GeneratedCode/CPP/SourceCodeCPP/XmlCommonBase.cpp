 ...
 *
 * For Example you can add the prototype to XmlCommonBase.h and the following here:
 *
 *	void CXmlCommonBase::ToXmlFile	(	LPCTSTR lpszFileName,
 ...
 *
 *		CXmlGeneratedClass::ToXmlFile(lpszFileName, bIncludeDocHeader, bFormatXML, encoding, eolType, context, compressionType);
 *
